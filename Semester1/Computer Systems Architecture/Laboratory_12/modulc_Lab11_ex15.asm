...
segment code use32 public code
    ...
    _get_resulted_sentence:
        ...
        mov eax, [ebp+12]
        mov [count_res], eax
        mov esi, [ebp+16]                 ; in ESI we will have the words that will be in the final sentence
        mov ecx, [ebp+8]                  ; ECX = n, the number of sentences
        read:
